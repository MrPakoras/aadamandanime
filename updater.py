...
bar = i.new(mode, (math.floor((twid-20)*perc), thei-20), (141,115,255))# Progress bar
...
PATH_OF_GIT_REPO = "H:/Anas' Stuff/HTML-CSS-JS/HTML/aadamandanime/.git"  # make sure .git folder is properly configured
